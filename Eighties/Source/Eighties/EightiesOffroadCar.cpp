...
#include "EightiesOffroadCar.h"
#include "EightiesOffroadWheelFront.h"
#include "EightiesOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AEightiesOffroadCar::AEightiesOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UEightiesOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UEightiesOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UEightiesOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UEightiesOffroadWheelRear::StaticClass();
