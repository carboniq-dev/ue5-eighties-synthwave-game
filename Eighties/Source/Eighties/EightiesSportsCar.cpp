...
#include "EightiesSportsCar.h"
#include "EightiesSportsWheelFront.h"
#include "EightiesSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AEightiesSportsCar::AEightiesSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UEightiesSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UEightiesSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UEightiesSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UEightiesSportsWheelRear::StaticClass();
